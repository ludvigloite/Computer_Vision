...
if __name__ == "__main__":
    ...
    plt.figure(figsize=(20, 8))
    #plt.subplot(1, 2, 1)
    plt.title("Cross Entropy Loss, Before and After Improved Network Architecture and Batch Normalization")
    ...
    utils.plot_loss(trainer_model2.train_history["loss"], label="Training loss after improvement", npoints_to_average=10)
    utils.plot_loss(trainer_model2.validation_history["loss"], label="Validation loss after improvement")
